export default function PrivacyPolicy() {
  return (
    <main className="container" style={{ padding: "60px 20px", maxWidth: 900, margin: "0 auto" }}>
      ...
      <p>Utilizamos o Google Analytics 4 para compreender como os visitantes utilizam o site, avaliar seu desempenho e melhorar a experiência de navegação.</p>
      <p>O serviço pode utilizar cookies e tecnologias semelhantes para registrar informações relacionadas à utilização do site.</p>
      <h2>4. WhatsApp</h2>
      ...
      <h2>5. Finalidades</h2>
      <p>Os dados podem ser utilizados para atendimento ao cliente, processamento e acompanhamento de pedidos, comunicação com o usuário, segurança, melhoria do site, análise de utilização e cumprimento de obrigações legais.</p>
